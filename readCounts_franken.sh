...
#featureCounts -p --countReadPairs -t transcript -f -g gene_id -a genome/merged_TX_noMatPAR_main.gtf -o readCounts/countsFrankenTX_genes RNAbams/merged_TX_noMatPAR/Rh_02_RNA_S122_L004_Aligned.sortedByCoord.out.bam
