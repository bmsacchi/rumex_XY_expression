slr_rename_NC<- function(x){mutate(x,
...
slr_rename_NC_PAR<-function(x){mutate(x,
...
slr_rename_TX_PAR<-function(x){mutate(x,
   region=if_else(genome == "tx_mat" & chr =="X" & end<=220000000,"SLR",
          if_else(genome == "tx_mat" & chr=="X" & end>220000000,"PAR",
          if_else(genome == "tx_pat" & chr=="Y" & end < 45000000,"PAR",
          if_else(genome == "tx_pat" & chr=="Y"& end >= 45000000, "SLR",NA)))))}
